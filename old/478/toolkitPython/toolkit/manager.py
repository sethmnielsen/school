...
from .dt_learner import DTLearner
...
class MLSystemManager:
    ...
    def main(self):
        ...
        # file_name = 'datasets/knnhw_train.arff'
        file_name = 'datasets/rover_obstacles_new.arff'
        # file_name = 'datasets/housing_train.arff'
        # file_name = 'datasets/credit.arff'
        learner_name = 'knn'
        eval_method = 'static'
        # eval_parameter = 'datasets/knnhw_test.arff'
        # eval_parameter = 'datasets/telescope_test.arff'
        eval_parameter = 'datasets/rover_obstacles_test_new.arff'
        # eval_parameter = 10
        ...
        classes = data.value_count(data.cols-1)
        if normalize:
        ...
        print("\nDataset name: {}\n"
              ...
              "Number of classes: {}\n"
              "Learning algorithm: {}\n"
              "Evaluation method: {}\n".format(file_name, data.rows, data.cols, classes, learner_name, eval_method))
        ...
        if eval_method == "training":
            ...
            # print('Nodes={}, Depth={}'.format(learner.nodes,learner.depth))
            ...
            confusion = Matrix()
            for k in range(7,16,2):
                learner.k = k
                print("k =",k)
                test_accuracy = learner.measure_accuracy(test_features, test_labels, confusion)
                if labels.value_count(0) == 0:
                    print("Test set MSE for k = {}: {}".format(k,test_accuracy))
                else:
                    print("Test set accuracy for k = {}: {}".format(k,test_accuracy))
            ...
            confusion = Matrix()
            test_accuracy = learner.measure_accuracy(test_features, test_labels, confusion)
            print("Test set accuracy for k = {}: {}".format(learner.k,test_accuracy))
            ...
            for j in range(reps):
                ...
                for i in range(folds):
                    ...
                    # print("Fold={}, Nodes={}, Depth={}, Train Accuracy={}, Test Accuracy={}".format(i,
                        # learner.nodes, learner.depth, train_accuracy, accuracy))
            print('In weights:', learner.in_weights)
    ...
    #     parser.add_argument('-L', required=True, choices=['baseline', 'perceptron', 'backprop', 'neuralnet', 'decisiontree', 'knn'], help='Learning Algorithm')
