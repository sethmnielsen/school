...
class plotData:
    ...
    def __init__(self):
        ...
        self.handle = []
        self.handle.append(myPlot(self.ax[0], ylabel='Position (m)', title='BOB Data'))
    ...
    def updatePlots(self, t, reference, states, ctrl):
        ...
        self.th_history.append(states[1]*180/np.pi)  # rod angle (converted to degrees)
        ...
        self.handle[1].updatePlot(self.time_history, [self.th_history])
