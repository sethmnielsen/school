...
class plotObserverData:
    ...
    def __init__(self):
        ...
        self.handle = []
        self.handle.append(myPlot(self.ax[0], ylabel='z (m)', title='VTOL Observer Data'))
        self.handle.append(myPlot(self.ax[1], ylabel='z_dot (m/s)'))
        self.handle.append(myPlot(self.ax[2], ylabel='h (m)'))
        self.handle.append(myPlot(self.ax[3], ylabel='h_dot (m/s)'))
        self.handle.append(myPlot(self.ax[4], ylabel='theta (deg)'))
        self.handle.append(myPlot(self.ax[5], xlabel='t(s)', ylabel='theta_dot (deg/s)'))

    def updatePlots(self, t, x, x_hat_lon, x_hat_lat):
        '''
        ...
        self.z_dot_history.append(x[0])
        self.h_dot_history.append(x[1])
        self.theta_dot_history.append(x[2])

        self.z_hat_history.append(x_hat_lat[0])
        self.h_hat_history.append(x_hat_lon[0])
        self.theta_hat_history.append(x_hat_lat[1])

        self.z_hat_dot_history.append(x_hat_lat[0])
        self.h_hat_dot_history.append(x_hat_lon[0])
        self.theta_hat_dot_history.append(x_hat_lat[1])
        ...
        self.handle[2].updatePlot(self.time_history, [self.h_history, self.h_hat_history])
        self.handle[3].updatePlot(self.time_history, [self.h_dot_history, self.h_hat_dot_history])
        self.handle[4].updatePlot(self.time_history, [self.theta_history, self.theta_hat_history])
