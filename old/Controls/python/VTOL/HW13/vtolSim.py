...
ctrl = vtolController()
freq = 0.01
reference_z = signalGenerator(amplitude=1.5, frequency=0.03, y_offset=3)
reference_h = signalGenerator(amplitude=1.0, frequency=0.06, y_offset=3.01)
...
while t < P.t_end:  # main simulation loop
    ...
    while t < t_next_plot: # updates control and dynamics at faster simulation rate
        [fr, fl] = ctrl.u(ref_input, vtol.states())  # Calculate the control value
        u = [fr, fl]
    ...
    observerPlot.updatePlots(t, vtol.states(), ctrl.x_hat_lon, ctrl.x_hat_lat)
