...
class plotObserverData:
    ...
    def __init__(self):
        ...
        self.handle = []
        self.handle.append(myPlot(self.ax[0], ylabel='p1 (m)', title='Double Sping-Mass-Damper Observer Data'))
        self.handle.append(myPlot(self.ax[1], ylabel='p1dot (m/s)'))
        self.handle.append(myPlot(self.ax[2], ylabel='p2 - p1 (m)'))
        self.handle.append(myPlot(self.ax[3], xlabel='t(s)', ylabel='p2dot - p1dot (m/s)'))
